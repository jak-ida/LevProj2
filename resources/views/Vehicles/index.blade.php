    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="container p-6">
                ...
                <a href="{{ route('vehicles.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mb-6 inline-block">Add Vehicle</a>
                        ...
                        <tbody>
                            @foreach($vehicles as $vehicle)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">{{ $vehicle->id }}</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">{{ $vehicle->make->name }}</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">{{ $vehicle->model->name }}</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">${{ number_format($vehicle->price, 2) }}</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">{{ $vehicle->year }}</td>
                                    <td class="px-4 py-2 border border-gray-300 dark:border-gray-700">
                                        <a href="{{ route('vehicles.edit', $vehicle) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-1 px-3 rounded">Edit</a>
